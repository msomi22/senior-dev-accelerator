...
const questions = [
  gradeOneMcq({
    ...
    optionVisuals: [shape('triangle'), shape('circle'), shape('square'), shape('rectangle')],
  ...
  gradeOneMcq({
    ...
    options: ['A', 'B', 'D', 'P'],
    optionVisuals: [textVisual('A'), textVisual('B'), textVisual('D'), textVisual('P')],
    correctAnswer: 'B',
  ...
  gradeOneMcq({
    ...
    options: ['B', 'M', 'S', 'T'],
    promptVisual: emoji('⚽'),
    optionVisuals: [textVisual('B'), textVisual('M'), textVisual('S'), textVisual('T')],
    correctAnswer: 'B',
  ...
  gradeOneMcq({
    ...
    options: ['sun', 'cup', 'dog', 'hat'],
    promptVisual: emoji('☀️'),
    optionVisuals: [emoji('☀️'), emoji('🥤'), emoji('🐶'), emoji('🎩')],
    correctAnswer: 'sun',
  ...
  gradeOneMcq({
    ...
    optionVisuals: [textVisual('b'), textVisual('a'), textVisual('c'), textVisual('d')],
    correctAnswer: 'a',
  ...
  gradeOneMcq({
    ...
    options: ['cat', 'cup', 'car', 'dog'],
    promptVisual: emoji('🐱'),
    optionVisuals: [emoji('🐱'), emoji('🥤'), emoji('🚗'), emoji('🐶')],
    correctAnswer: 'cat',
  ...
  gradeOneMcq({
    ...
    optionVisuals: [objects('⭐', 1), objects('⭐', 2), objects('⭐', 3), objects('⭐', 4)],
    correctAnswer: '3',
  ...
  gradeOneMcq({
    ...
    optionVisuals: [textVisual('4'), textVisual('5'), textVisual('6'), textVisual('7')],
    correctAnswer: '6',
  ...
  gradeOneMcq({
    ...
    options: ['dog', 'dig', 'dot', 'dad'],
    promptVisual: emoji('🐶'),
    optionVisuals: [emoji('🐶'), emoji('⛏️'), emoji('•'), emoji('👨')],
    correctAnswer: 'dog',
  ...
  gradeOneMcq({
    ...
    options: ['Thank you', 'Go away', 'Stop', 'No'],
    promptVisual: emoji('🎁'),
    optionVisuals: [emoji('🙏'), emoji('🚶'), emoji('🛑'), emoji('❌')],
  ...
  gradeOneMcq({
    ...
    options: ['Run fast', 'Look left and right', 'Close your eyes', 'Play'],
    promptVisual: emoji('🚦'),
    optionVisuals: [emoji('🏃'), emoji('👀'), emoji('🙈'), emoji('🧸')],
