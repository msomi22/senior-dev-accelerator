...
const problem = defineLearningProblem({
  ...
  visualExplanation: 'The visual walkthrough image traces the life of one Deployment request from kubectl to the API server, into desired state, through controllers and scheduling, onto a worker node, and finally through Service DNS and networking.',
  visualWalkthrough: {
    title: 'Kubernetes architecture visual walkthrough',
    summary: 'Use the architecture image as the main visual. The highlights call out the critical flow to remember.',
    image: '/images/problems/kubernetes-ckad/kubernetes-architecture-foundation.png',
    imageAlt: 'Kubernetes architecture diagram showing kubectl, kubeconfig, API server, etcd, controllers, scheduler, kubelet, runtime, Pods, Service, Endpoints, and CoreDNS',
    steps: [
