...
function VisualStyles() {
  return (
    <style>{`
      ...
      .config-visual-array-item { min-width: 42px; min-height: 42px; display: grid; place-items: center; border-radius: 14px; border: 1px solid rgba(86, 67, 42, 0.14); background: rgba(255,255,255,0.54); font-weight: 900; }
